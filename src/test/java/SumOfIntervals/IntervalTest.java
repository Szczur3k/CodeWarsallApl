...
import static SumOfIntervals.Interval.sumIntervals;
...
//        assertEquals(13, sumIntervals(new int[][]{{2, 5}, {-1, 2}, {-40, -35}, {6, 8}}));
    ...
    public void shouldHandleRandomIntervals() {
        assertEquals(19658, sumIntervals(new int[][]{{9267, 9660}, {-2426, 431}, {-3104, 6921}, {222, 5420},
                {-2936, 8218}, {-7753, 775}, {-2130, 601}, {-9960, -9704},{7365, 8865}, {-2439, -1832}, {3412, 7949},
                {-1255, 2141}, {-1993, 2846}, {-6455, 1392}, {-545, 7976}, {2041, 3092}, {-1893, 56}, {3916, 5853},
                {-9998, -2526}, {-1456, 8095}, {-7128, 6890}, {8297, 9336}, {-3186, 321}}));
    }
}