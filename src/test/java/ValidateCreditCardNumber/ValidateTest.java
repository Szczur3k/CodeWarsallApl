...
class ValidateTest {
    ...
    public void test1234() {
        assertEquals(false, Validate.validate("1234"));
    }

    @Test
    public void test2724() {
        assertEquals(false, Validate.validate("2724"));
    }

    @Test
    public void test637485940123() {
        assertEquals(false, Validate.validate("637485940123"));
    }
